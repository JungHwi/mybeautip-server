...
public class CommunityLikeTwentyNotificationService implements NotificationService<PostLike> {
    ...
    private boolean verify(PostLike postLike) {
        ...
        return countLike == TWENTY && postLike.getCreatedAt().equals(postLike.getModifiedAt());
    }
