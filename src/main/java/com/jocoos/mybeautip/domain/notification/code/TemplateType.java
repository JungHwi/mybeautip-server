...
public enum TemplateType implements CodeValue {
    VIDEO_UPLOAD("동영상 업로드 시, 모든 유저에게", newHashSet(SendType.CENTER, SendType.APP_PUSH), newHashSet(NotificationArgument.USER_NICKNAME, NotificationArgument.CONTENT_ID)),
