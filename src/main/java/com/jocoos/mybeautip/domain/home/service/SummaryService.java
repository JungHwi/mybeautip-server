...
public class SummaryService {
    ...
    private List<CommunityResponse> blindSummary(Long blindCategoryId) {
        List<SummaryResult> blinds = communityDao.summary(blindCategoryId, BLIND, BLIND_SUMMARY.getCount());
        return summaryConverter.convertBlindSummary(blinds);
    }

    private List<CommunityResponse> voteSummary(Long voteCategoryId) {
        List<SummaryResult> votes = communityDao.summary(voteCategoryId, VOTE, VOTE_SUMMARY.getCount());
