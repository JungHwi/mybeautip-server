...
//    }
    ...
    @AfterReturning(value = "execution(* com.jocoos.mybeautip.restapi.LegacyVideoController.addView(..)) " +
            "|| execution(* com.jocoos.mybeautip.restapi.LegacyVideoController.joinWatch(..))",
            returning = "result")
