...
=== EVENT API
* link:event/admin_create_event[이벤트 생성 API, window=_blank]
* link:event/admin_edit_event[이벤트 수정 API, window=_blank]
* link:event/admin_upload_event_file[이벤트 파일 업로드 API, window=_blank]
...
* link:member/patch_member_memo.html[멤버 메모 수정 및 작성 API, window=_blank]
