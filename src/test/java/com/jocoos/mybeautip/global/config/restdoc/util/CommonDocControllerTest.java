    ...
    public void enums() throws Exception {
        ...
        result.andExpect(status().isOk())
                .andDo(restDocs.document(
                        ...
                        customResponseFields("custom-response", beneathPath("data.member_activity_type").withSubsectionId("member_activity_type"),
                                attributes(key("title").value("memberActivityType")),
                                enumConvertFieldDescriptor((enumDocs.getMemberActivityType()))
                        ),
                        // Broadcast
                        ...
                        customResponseFields("custom-response", beneathPath("data.broadcast_report_type").withSubsectionId("broadcast_report_type"),
                                attributes(key("title").value("BroadcastReportType")),
                                enumConvertFieldDescriptor((enumDocs.getBroadcastReportType()))
                        ),
                        ...
                        // Delivery
                        customResponseFields("custom-response", beneathPath("data.delivery_company_status").withSubsectionId("company_status"),
                        ...
                        customResponseFields("custom-response", beneathPath("data.delivery_fee_type").withSubsectionId("delivery_fee_type"),
                                attributes(key("title").value("DeliveryFeeType")),
                                enumConvertFieldDescriptor((enumDocs.getDeliveryFeeType()))
                        ),
                        customResponseFields("custom-response", beneathPath("data.delivery_method").withSubsectionId("delivery_method"),
                                attributes(key("title").value("DeliveryMethod")),
                                enumConvertFieldDescriptor((enumDocs.getDeliveryMethod()))
                        ),
                        customResponseFields("custom-response", beneathPath("data.payment_option").withSubsectionId("payment_option"),
                                attributes(key("title").value("PaymentOption")),
                                enumConvertFieldDescriptor((enumDocs.getPaymentOption()))
                        ),
                        // Product
                        // Store
                        ...
                        // Vod
                        customResponseFields("custom-response", beneathPath("data.scrap_type").withSubsectionId("scrap_type"),
                                attributes(key("title").value("ScrapType")),
                                enumConvertFieldDescriptor((enumDocs.getScrapType()))
                        ),
                        // FFL
