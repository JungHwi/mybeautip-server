    ...
    void searchVideoTest() throws Exception {
        ...
        result.andDo(document("search_video",
                ...
                responseFields(
                        ...
                        fieldWithPath("video.[].owner.grant_type").type(JsonFieldType.STRING).description(DocumentLinkGenerator.generateLinkCode(DocumentLinkGenerator.DocUrl.GRANT_TYPE)),
