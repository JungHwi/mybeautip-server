    ...
    void writeCommunity() throws Exception {
        ...
        result.andDo(document("write_community",
                        ...
                        responseFields(
                                ...
                                fieldWithPath("relation_info.user_voted").type(JsonFieldType.NUMBER).description("유저가 투표한 파일").optional(),
    ...
    void getCommunities() throws Exception {
        ...
        result.andDo(document("get_communities",
                        ...
                        responseFields(
                                ...
                                fieldWithPath("content.[].relation_info.user_voted").type(JsonFieldType.NUMBER).description("유저가 투표한 파일").optional(),
