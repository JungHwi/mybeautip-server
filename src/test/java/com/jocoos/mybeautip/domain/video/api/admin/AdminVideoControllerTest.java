    ...
    void getVideos() throws Exception {
        ...
        result.andDo(document("admin_get_videos",
                requestParameters(
                        ...
                        parameterWithName("sort").description("정렬 필드 (createdAt, viewCount, likeCount, commentCount, reportCount)").optional().attributes(getDefault("startedAt")),
                ...
                responseFields(
                        ...
                        fieldWithPath("content.[].started_at").type(JsonFieldType.STRING).description("게시일").attributes(getZonedDateFormat()),
