    ...
    void getVideos() throws Exception {
        ...
        result.andDo(document("get_videos",
                        ...
                        responseFields(
                                ...
                                fieldWithPath("content.[].content").type(JsonFieldType.STRING).description("컨텐츠"),
                                fieldWithPath("content.[].url").type(JsonFieldType.STRING).description("비디오 파일 주소"),
                                fieldWithPath("content.[].thumbnail_path").type(JsonFieldType.STRING).description("썸네일 경로"),
                                fieldWithPath("content.[].thumbnail_url").type(JsonFieldType.STRING).description("썸네일 URL"),
                                fieldWithPath("content.[].chat_room_id").type(JsonFieldType.STRING).description("채팅방 아이디"),
                                fieldWithPath("content.[].duration").type(JsonFieldType.NUMBER).description("방송 길이. mm 초 단위"),
                                fieldWithPath("content.[].total_watch_count").type(JsonFieldType.NUMBER).description("총 시청"),
                                fieldWithPath("content.[].real_watch_count").type(JsonFieldType.NUMBER).description("실시청자수"),
                                ...
                                fieldWithPath("content.[].data").type(JsonFieldType.STRING).description("상품 정보등"),
                                fieldWithPath("content.[].related_goods_count").type(JsonFieldType.NUMBER).description("관련 상품 갯수"),
                                fieldWithPath("content.[].related_goods_thumbnail_url").type(JsonFieldType.STRING).description("상품 대표 URL"),
    ...
    void getVideo() throws Exception {
        ...
        result.andDo(document("get_video",
                        ...
                        responseFields(
                                ...
                                fieldWithPath("thumbnail_path").type(JsonFieldType.STRING).description("썸네일 경로"),
                                fieldWithPath("thumbnail_url").type(JsonFieldType.STRING).description("썸네일 URL"),
                                fieldWithPath("chat_room_id").type(JsonFieldType.STRING).description("채팅방 아이디"),
                                fieldWithPath("duration").type(JsonFieldType.NUMBER).description("방송 길이. mm 초 단위"),
                                fieldWithPath("total_watch_count").type(JsonFieldType.NUMBER).description("총 시청"),
                                fieldWithPath("real_watch_count").type(JsonFieldType.NUMBER).description("실시청자수"),
                                ...
                                fieldWithPath("data").type(JsonFieldType.STRING).description("상품 정보등"),
                                fieldWithPath("related_goods_count").type(JsonFieldType.NUMBER).description("관련 상품 갯수"),
                                fieldWithPath("related_goods_thumbnail_url").type(JsonFieldType.STRING).description("상품 대표 URL"),
