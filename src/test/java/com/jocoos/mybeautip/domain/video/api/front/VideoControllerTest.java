    ...
    void getVideos() throws Exception {
        ...
        result.andDo(document("get_videos",
                        ...
                        responseFields(
                                ...
                                fieldWithPath("content.[].owner.grant_type").type(JsonFieldType.STRING).description(DocumentLinkGenerator.generateLinkCode(DocumentLinkGenerator.DocUrl.GRANT_TYPE)),
