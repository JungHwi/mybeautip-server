        ...
        resultActions.andDo(
            document(
                ...
                responseFields(
                    ...
                    fieldWithPath("broadcast_permission").type(OBJECT).description("방송 관련 권한 정보"),
                    fieldWithPath("broadcast_permission.available_broadcast").type(BOOLEAN).description("방송 가능 여부"),
                    fieldWithPath("broadcast_permission.viewable_live_menu").type(BOOLEAN).description("마이페이지 > 라이브 메뉴 노출 여부"),
