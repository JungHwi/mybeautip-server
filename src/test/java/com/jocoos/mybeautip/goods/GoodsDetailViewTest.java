...
public class GoodsDetailViewTest {
  ...
  public static void main(String[] args) {
    String html = "<div class=\"js_goods_description\">" +
       "<div align=\"center\" style=\"color:#fff; font-size:16px; font-weight:normal; margin:24px 0; padding:32px; background: #eee url(https://s3.ap-northeast-2.amazonaws.com/mybeautip/banner/20180706_timedeal01.png) no-repeat center center; background-size: cover;  text-align: center;\">" +
       ...
       "<video width=\"100%\" height=\"100%\" id=\"video-player\" class=\"embed-responsive-item\" controls=\"\" preload=\"auto\" x-webkit-ariplay=\"allow\" webkit-playsinline=\"allow\" playsinline=\"\" src=\"https://s3.ap-northeast-2.amazonaws.com/flipflop-dev/testapp2/videos/11178/vod.mp4\" poster=\"https://s3.ap-northeast-2.amazonaws.com/flipflop-dev/testapp2/videos/11178/11178.png\"></video>\n" +
       "</div>\n" + "\n" +
       "<p><a href=\"/member/join_method.php\" style=\"color:#fff; font-weight:normal; text-decoration:underline\">회원가입</a></p>\n" +
       "<div align=\"center\">" +
       "<img src=\"https://s3.ap-northeast-2.amazonaws.com/mybeautip/supplier/header_hitomi.png\" style=\"max-width: 100%; height: auto;\">" +
       "</div>" +
       "    <div align=\"center\">" +
       "<img src=\"https://s3.ap-northeast-2.amazonaws.com/mybeautip/supplier/header_hitomi_ysl.png\" style=\"max-width: 100%; height: auto;\">" +
       "</div>" +
